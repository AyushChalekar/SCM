...
public class OrderDeliveredPage extends JFrame {
    ...
    private JButton backButton, logoutButton, searchButton, sortbutton;
    private JTable ordersTable;
    private DefaultTableModel ordersTableModel;

    public OrderDeliveredPage(UserData currentUser) {
        ...
        // Load initial data, passing the current user
    ...
    private void loadOrdersData(UserData currentUser) {
        String query = "SELECT o.order_id, u.username, o.product_id, o.product_details, o.quantity, o.status, o.tracking_id, o.order_deatils " +
                ...
                "WHERE u.username = ? AND o.status = 'Delivered'";
