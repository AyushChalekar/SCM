...
public class OrderDeliveredPage extends JFrame {
    ...
    private JButton createStyledButton(String text, String iconPath) {
        ...
        button.setPreferredSize(new Dimension(100, 30)); // Smaller size for buttons
    ...
    private void saveChanges() {
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/wms1", "root", "root")) {
            for (int i = 0; i < rowCount; i++) {
                ...
                String orderDetails = (String) ordersTableModel.getValueAt(i, 7); // Order details in the eighth column
